            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    if (msgFromServer.equals("Username already taken")) {// if server sent this message then prompt user
                        ...
                        JOptionPane.showMessageDialog(frame, "Please choose from a,b or c only."); // show message in
                                                                                                   // other dialog box
                    } else {
                        new ClientView3(id, s); // otherwise just create a new thread of Client view and close the
                                                // register jframe
                        frame.dispose();
                    }
                } catch (Exception ex) {
